      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between bg-card border-b px-3 h-16 md:hidden shadow-sm">
        ...
        <div className="flex items-center gap-2 flex-1 justify-center">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-success">
            <span className="text-white font-bold text-sm">FPP</span>
          </div>
          <span className="font-semibold text-lg">Financial Planner</span>
        </div>
          ...
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                <span className="font-bold text-sm leading-tight">Financial</span>
                <span className="text-xs text-muted-foreground leading-tight">Planner</span>
              </div>
            )}
          </Link>
